...
export const TodoToolbar: React.FC = () => {
	...
	const reorderTooltip = useTooltip("Click to reorder todos by insertion order")
	...
	return (
		<div className="flex flex-col gap-1">
			<div className='flex flex-col xs:flex-row justify-between gap-2 border-b border-slate-400 pb-2'>
				<div {...searchTooltip} className="flex flex-row items-center w-full gap-1 bg-slate-600 rounded-sm p-1">
...
const ToolbarButton: React.FC<ToolbarButtonProps> = ({ className, children, onClick, ...args}) => {
	return (
		<button
			{...args}
